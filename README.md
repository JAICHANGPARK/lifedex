...
Gotcha Lite는 일상 속 사물이나 반려동물을 카메라로 촬영하거나 갤러리에서 선택하여, 외부 서버 통신 없이 디바이스 내에서 배경을 투명하게 지우고(**온디바이스 누끼 추출**), 이를 포켓몬 스타일의 **수집용 디지털 카드**로 가공하여 지도와 도감에 기록하는 네이티브 안드로이드 어플리케이션입니다.
...
### 4. 로컬 캔버스 포켓몬 카드 생성 (Local Card Generator)
...
│   │   │   │   │   ├── GotchaDao.kt
│   │   │   │   │   └── ...
│   │   │   │   ├── service/               # 누끼 엔진, Gemini API 연동, 포켓몬 카드 생성기
│   │   │   │   │   ├── NukiService.kt
│   │   │   │   │   ├── GeminiClient.kt
│   │   │   │   │   └── CardGenerator.kt
